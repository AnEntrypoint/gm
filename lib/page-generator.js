...
const PLATFORM_META = {
  skill: { repoId: 'gm-skill', label: 'gm-skill (universal harness)', type: 'skill', badgeLabel: 'skill', installSteps: [{ desc: 'install globally into your agent host', cmd: 'bun x skills add AnEntrypoint/gm-skill -y -g' }, { desc: 'add to global memory / system prompt: always use the gm-skill skill for everything, always fan out subagents' }] }
};
