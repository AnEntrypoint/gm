...
const PLATFORM_META = {
  skill: { repoId: 'gm-skill', label: 'gm-skill (universal harness)', type: 'skill', badgeLabel: 'skill', installSteps: [{ desc: 'install via npm', cmd: 'npm install -g gm-skill' }, { desc: 'invoke from any harness via Skill(skill="gm:gm-skill") or equivalent' }] }
};
